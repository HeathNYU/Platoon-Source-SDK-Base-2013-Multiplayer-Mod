...
public:
	...
	virtual void			DropNew( const Vector &vecVelocity );
...
public:
	...
	void					ThrowChunks(CBaseEntity *pChopper, const Vector &vecChunkPos, const QAngle &vecChunkAngles, const char *pszChunkName);
...
public:
	...
	CNetworkVar( float, m_flNextClipFill );
	CNetworkVar( bool, m_bInReload );									// Are we in the middle of a reload;
	CNetworkVar( bool, m_bReloadCanceled );
...
public:
	...
	CNetworkVar( bool, m_bWeaponIsLowered);
