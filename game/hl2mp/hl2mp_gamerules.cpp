...
CHL2MPRules::CHL2MPRules()
{
	...
	CreateEntityByName("hl2mp_gamerules");
...
void CHL2MPRules::CheckRestartGame( void )
{
	...
	if ( iRestartDelay > 0 )
	{
		...
		UTIL_ClientPrintAll( HUD_PRINTCENTER, "Attention! Game will restart in %s1 %s2", strRestartDelay, iRestartDelay == 1 ? "SECOND" : "SECONDS" );
		UTIL_ClientPrintAll( HUD_PRINTCONSOLE, "Attention! Game will restart in %s1 %s2", strRestartDelay, iRestartDelay == 1 ? "SECOND" : "SECONDS" );
