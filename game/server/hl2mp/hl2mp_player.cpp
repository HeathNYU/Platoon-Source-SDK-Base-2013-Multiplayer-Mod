...
void CHL2MP_Player::GiveAllItems( void )
{
	...
	CBasePlayer::GiveAmmo( 0,	"Pistol");
	CBasePlayer::GiveAmmo( 0,	"AR2" );
	CBasePlayer::GiveAmmo( 0,	"AR2AltFire" );
	CBasePlayer::GiveAmmo( 0,	"SMG1");
	CBasePlayer::GiveAmmo( 1,	"smg1_grenade");
	CBasePlayer::GiveAmmo( 0,	"Buckshot");
	CBasePlayer::GiveAmmo( 0,	"357" );
...
CBaseEntity* CHL2MP_Player::EntSelectSpawnPoint( void )
{
	...
	if ( HL2MPRules()->IsTeamplay() == true )
	{
		if ( GetTeamNumber() == TEAM_COMBINE )
		{
			pSpawnpointName = "info_player_USMC";
			pLastSpawnPoint = g_pLastCombineSpawn;
		}
		else if ( GetTeamNumber() == TEAM_REBELS )
		{
			pSpawnpointName = "info_player_NVA";
			pLastSpawnPoint = g_pLastRebelSpawn;
		}

		if ( gEntList.FindEntityByClassname( NULL, pSpawnpointName ) == NULL )
		{
			pSpawnpointName = "info_player_platoon";
