...
public:
	...
	void InputExtend( inputdata_t &inputdata );
...
BEGIN_DATADESC( CTimerEntity )
	...
	DEFINE_KEYFIELD( m_iExtendRoundtimerBy, FIELD_INTEGER, "Extend Roundtimer By" ),
	...
	DEFINE_INPUTFUNC( FIELD_VOID, "ExtendRoundtimer", InputExtend ),
...
void CTimerEntity::Extend(void)
{
	if (!m_iDisabled)
	{
		...
		pRules->ExtendRoundtimer(m_iExtendRoundtimerBy);
	}
}
...
void CTimerEntity::InputExtend(inputdata_t &inputdata)
{
	Extend();
}
