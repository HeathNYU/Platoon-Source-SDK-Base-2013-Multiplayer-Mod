...
// Assume sound system is 40 msec lagged (only used if we can't find snd_mixahead cvar!)
#define SOUND_SYSTEM_LATENCY_DEFAULT ( 0.04f )

// Think every 10 msec (FIXME: Try 10hz?)
