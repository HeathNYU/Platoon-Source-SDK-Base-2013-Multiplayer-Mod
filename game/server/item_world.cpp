...
#define ITEM_PICKUP_BOX_BLOAT	15
...
void CItem::Event_Killed(const CTakeDamageInfo &info)
{
	for (int i = 0; i < 8; i++)
	{
...
void CItem::ThrowChunks(CBaseEntity *pItem, const Vector &vecChunkPos, const QAngle &vecChunkAngles, const char *pszChunkName)
{
	...
	vecVelocity += pItem->GetAbsVelocity();
