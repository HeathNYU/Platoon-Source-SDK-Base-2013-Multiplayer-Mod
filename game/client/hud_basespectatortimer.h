...
//-----------------------------------------------------------------------------
class CHudBaseSpectatorTimer : public CHudNumericDisplay
{
	DECLARE_CLASS_SIMPLE( CHudBaseSpectatorTimer, CHudNumericDisplay );

public:
	CHudBaseSpectatorTimer(vgui::Panel *parent, const char *name);
